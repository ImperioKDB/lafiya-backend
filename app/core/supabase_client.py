...
# role lookups at login, and writes to guarantor_reputation, which has
# RLS enabled with zero public policies on purpose (see blueprint SS14).
...
# loans, guarantors, chw_earnings, disbursement_claims) -- RLS is the
# real enforcement layer, the FastAPI role check is a second line of
